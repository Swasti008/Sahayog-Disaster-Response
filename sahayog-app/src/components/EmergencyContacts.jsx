          ...
          <div className="space-y-4">
            {[
              { 
                ...
                number: stateData.emergency_numbers.centralized_emergency_number 
              },
              { 
                icon: AlertTriangle, 
                  ...
                  {[
                    {
                      ...
                      emergency: selectedDistrictData.fire_department.emergency_number,
                      contact: selectedDistrictData.fire_department.contact_number
                    },
                    {
                      icon: AlertTriangle,
                      iconColor: 'text-red-600',
                      title: 'Police Station',
                      emergency: selectedDistrictData.police_station.emergency_number,
                      contact: selectedDistrictData.police_station.contact_number
                    },
                    {
                      icon: Hospital,
                      iconColor: 'text-blue-600',
                      title: 'Hospital',
                      emergency: selectedDistrictData.hospitals[0].name,
                      contact: selectedDistrictData.hospitals[0].contact_number
                    }
                  ].map((section, index) => (
                    <div 
                      key={index} 
